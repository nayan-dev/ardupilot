...
#elif CONFIG_HAL_BOARD == HAL_BOARD_PX4 && (defined(CONFIG_ARCH_BOARD_PX4FMU_V2) || defined(CONFIG_ARCH_BOARD_PX4FMU_V4) || defined(CONFIG_ARCH_BOARD_PX4FMU_V4PRO) || defined(CONFIG_ARCH_BOARD_SPARROW_V10) || defined(CONFIG_ARCH_BOARD_PX4SPARROW_V11))
 // pixhawk
