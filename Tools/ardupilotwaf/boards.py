...
class sparrow_v10(px4):
    name = 'sparrow-v10'
    def __init__(self):
        super(sparrow_v10, self).__init__()
        self.bootloader_name = 'sparrowv10_bl.bin'
        self.board_name = 'sparrow-v10'
        self.romfs_exclude(['oreoled.bin'])
        self.with_uavcan = True
...
class sparrow_v11(px4):
    name = 'sparrow-v11'
    def __init__(self):
        super(sparrow_v11, self).__init__()
        self.bootloader_name = 'sparrowv11_bl.bin'
