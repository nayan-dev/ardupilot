...
#if defined(CONFIG_ARCH_BOARD_PX4FMU_V2) || defined(CONFIG_ARCH_BOARD_SPARROW_V10) || defined(CONFIG_ARCH_BOARD_PX4FMU_V10) || defined(CONFIG_ARCH_BOARD_SPARROW_V11)
