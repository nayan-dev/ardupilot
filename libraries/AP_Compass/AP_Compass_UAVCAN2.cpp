 ...
 */
AP_Compass_UAVCAN2::AP_Compass_UAVCAN2(Compass &compass):
    AP_Compass_Backend(compass)
{
    _mag_baro = hal.util->new_semaphore();
}

AP_Compass_UAVCAN2::~AP_Compass_UAVCAN2()
{
    if (_initialized)
    {
...
AP_Compass_Backend *AP_Compass_UAVCAN2::probe(Compass &compass)
{
    AP_Compass_UAVCAN2 *sensor = nullptr;
                ...
                if (uavcan != nullptr) {
                    ...
                    if (freemag != UINT8_MAX) {
                        ...
                        if (sensor->register_uavcan_compass(i, freemag)) {
                            debug_mag_uavcan(2, "AP_Compass_UAVCAN2 probed, drv: %d, node: %d\n\r", i, freemag);
                            return sensor;
                        } else {
                            delete sensor;
                            sensor = nullptr;
...
bool AP_Compass_UAVCAN2::register_uavcan_compass(uint8_t mgr, uint8_t node)
{
    if (hal.can_mgr[mgr] != nullptr) {
        ...
        if (ap_uavcan != nullptr) {
            ...
            if (ap_uavcan->register_mag_listener_to_node(this, node)) {
                ...
                debug_mag_uavcan(2, "AP_Compass_UAVCAN2 loaded\n\r");
...
void AP_Compass_UAVCAN2::read(void)
{
...
void AP_Compass_UAVCAN2::handle_mag_msg(Vector3f &mag)
{
