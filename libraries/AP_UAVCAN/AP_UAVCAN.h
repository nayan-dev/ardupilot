...
public:
    ...
    uint8_t register_mag2_listener(AP_Compass_Backend* new_listener, uint8_t preferred_channel);
    void remove_mag2_listener(AP_Compass_Backend* rem_listener);
    Mag_Info *find_mag2_node(uint8_t node);
    uint8_t find_smallest_free_mag2_node();
    uint8_t register_mag2_listener_to_node(AP_Compass_Backend* new_listener, uint8_t node);
