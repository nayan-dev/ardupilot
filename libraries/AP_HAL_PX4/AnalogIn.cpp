...
#elif defined(CONFIG_ARCH_BOARD_PX4FMU_V2) || defined(CONFIG_ARCH_BOARD_PX4FMU_V4) || defined(CONFIG_ARCH_BOARD_PX4FMU_V4PRO) || defined(CONFIG_ARCH_BOARD_SPARROW_V10) || defined(CONFIG_ARCH_BOARD_PX4FMU_V10) || defined(CONFIG_ARCH_BOARD_SPARROW_V11)
...
#if defined(CONFIG_ARCH_BOARD_PX4FMU_V2) || defined(CONFIG_ARCH_BOARD_PX4FMU_V4) || defined(CONFIG_ARCH_BOARD_SPARROW_V10) || defined(CONFIG_ARCH_BOARD_PX4FMU_V10) || defined(CONFIG_ARCH_BOARD_SPARROW_V11)
