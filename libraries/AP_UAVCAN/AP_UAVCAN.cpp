...
static void magnetic_cb0_2(const uavcan::ReceivedDataStructure<uavcan::equipment::ahrs::MagneticFieldStrength2>& msg)
{   magnetic_cb_2(msg, 0); }
static void magnetic_cb1_2(const uavcan::ReceivedDataStructure<uavcan::equipment::ahrs::MagneticFieldStrength2>& msg)
{   magnetic_cb_2(msg, 1); }
static void (*magnetic_cb_arr_2[2])(const uavcan::ReceivedDataStructure<uavcan::equipment::ahrs::MagneticFieldStrength2>& msg)
        = { magnetic_cb0_2, magnetic_cb1_2 };
        ...
        if (_parent_can_mgr->is_initialized() && !_initialized) {
            ...
            if (node != nullptr) {
                if (!node->isStarted()) {
                    ...
                    uavcan::Subscriber<uavcan::equipment::ahrs::MagneticFieldStrength2> *magnetic_2;
                    magnetic_2 = new uavcan::Subscriber<uavcan::equipment::ahrs::MagneticFieldStrength2>(*node);
                    const int magnetic_start_res_2 = magnetic_2->start(magnetic_cb_arr_2[_uavcan_i]);
...
void AP_UAVCAN::do_cyclic(void)
{
    if (_initialized) {
        ...
        if (error < 0) {
            ...
            if (AP_BoardConfig_CAN::get_can_debug() >= 2) { //print CAN status at one hertz on console
